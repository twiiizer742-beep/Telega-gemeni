...
const SYSTEM_PROMPT =
  ...
  'Твой стиль: дружелюбный, без официоза, без лишних тире. Пиши как реальный человек. ' +
  'ВАЖНО: Никогда не используй символы "*" (звездочки) для выделения текста. ' +
  'Вместо списков используй цифры или просто переноси текст на новую строку. ' +
